  ...
  Bench : {
    ...
    start : function(){
      for (var i=0; i < this.suites.length; i++) {
        ...
        this.suites[i].measure = true;
      };
      return this
    },

    addSuite : function(title, times, block){
      this.suites.push(this.createSuite(title,times,block));
      return this
    },
    ...
    createSuite : function(title, times, block){
      var newSuite = {
